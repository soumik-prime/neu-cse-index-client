...
function VerifyOtpContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSuccess(true);
      // Redirect to change password after 2 seconds
      setTimeout(
        () => router.push(
          `/change-password?email=${encodeURIComponent(email)}&otp=${otp}`,
        ),
        2000,
      );
    } catch {
        ...
        <main className="min-h-dvh flex flex-col items-center justify-center px-4">
          ...
          <div className="w-full max-w-sm surface surface-accent" style={{ padding: "32px 28px" }}>
            <div className="text-center">
              ...
              <h4 style={{ color: "#d4eae8", fontFamily: "var(--font-display)" }}>Code verified</h4>
      ...
      <main className="min-h-dvh flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          <Link
            ...
            className="mt-4 inline-flex items-center gap-1.5 text-text-secondary text-xs font-mono mb-6 hover:text-[#22a899] transition-colors"
          >
            <BackIcon /> Back
          </Link>
          ...
          <h4
            className="mb-1"
            style={{ color: "#d4eae8", fontFamily: "var(--font-display)" }}
          >
            Enter code
          </h4>
                ...
                <input
                  ...
                  onFocusCapture={(e) => {
                    ...
                    e.target.style.boxShadow =
                      "0 0 0 3px rgba(34,168,153,0.15)";
                  }}
                  onBlurCapture={(e) => {
